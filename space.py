...
#Register Shapes for player and enemy
...
while True:
    for enemy in enemies:
        ...
        #Check if the collision occurs between the bullet and the enemy
...
turtle.mainloop()
delay = input("Press enter tto exit")
